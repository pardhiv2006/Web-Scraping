...
from ingest_csvs import normalise_country, normalise_state, is_garbage_company

def count_csv_england_garbage():
        ...
        for row in reader:
            ...
            if country == "UK" and state == "England":
                if is_garbage_company(name):
                    garbage_count += 1
    print(f"Garbage England records in CSV: {garbage_count}")

if __name__ == "__main__":
    count_csv_england_garbage()
